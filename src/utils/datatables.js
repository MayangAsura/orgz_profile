...
// export const dataTable = new DataTable("#default-table");
    // if (document.getElementById("export-table") && typeof dataTable.DataTable !== 'undefined') {
    ...
    //         const csv = dataTable.exportCSV(dataTable, clonedUserOptions)
    ...
    //         return str
    //     }
    //     const table = new dataTable.DataTable("#export-table", {
    ...
    //         dataTable.exportSQL(table, {
    //             download: true,
    //             tableName: "export_table"
    //         })
    //     })
    //     document.getElementById("export-txt").addEventListener("click", () => {
    //         dataTable.exportTXT(table, {
    //             download: true
    //         })
    //     })
    //     document.getElementById("export-json").addEventListener("click", () => {
    //         dataTable.exportJSON(table, {
    //             download: true,
    //             space: 3
    //         })
    //     })
