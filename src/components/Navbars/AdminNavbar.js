      ...
      <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          ...
          <li>
            <div className="flex items-center space-x-1.5">
              ...
              <a href={`/admin/${page_title}`} className="inline-flex items-center text-sm font-medium text-body hover:text-fg-brand">{page_title?.slice(0,1).toUpperCase() + page_title?.slice(- (page_title?.length - 1))}</a>
            </div>
          </li>
