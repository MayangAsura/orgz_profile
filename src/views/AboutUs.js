...
const abouts = [
    { org_name: "Rumah Qur'an Al Ayman", content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum."}
]
    ...
    <>
        ...
        <div className="pt-6">
            ...
            <div className="relative block mt-4 mb-5 cols-span-8 lg:cols-span-12 lg:mt-0 p-5 rounded-2xl border border-gray-300 bg-white border-md shadow-sm">
                    ...
                    <div className=''>
                        <p className="text-xl tracking-tight text-gray-900">{abouts.org_name} </p>
                        <p>{abouts.content} </p>
