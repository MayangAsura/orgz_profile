        ...
        <div className="w-full px-4">
          ...
          <div className="rounded-t bg-white mb-0 px-6 py-6">
            <div className="text-center flex justify-between">
              <h6 className="text-blueGray-700 text-xl font-bold">Transaksi #{transactions.invoice_number} </h6>
              <span className={`${transactions.order_status ==='successed'? 'bg-green-400' : transactions.order_status ==='failed'? 'bg-red-400': 'bg-yellow-400' } px-3 py-2 rounded-md`}>{transactions.order_status} </span>
              {/* <button
              ...
              <div className="flex flex-wrap">
                ...
                <div className="w-full lg:w-6/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <span className="text-base text-gray-700"> {transactions.total_amount} </span>
                  </div>
                </div>
                <div className="w-full lg:w-6/12 px-4">
                  <div className="relative w-full mb-3">
                ...
                <div className="w-full lg:w-6/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    <span className="text-base text-gray-700"> {transactions.orgz_packets && transactions.orgz_packets.name} </span>
                  </div>
                </div>
              </div>
          ...
          <div className="relative flex flex-col  min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            <div className="flex-auto bg-white px-4 lg:px-10 py-10 pt-0">
              ...
              <div className="mt-10">
                  {
                      transactions.orgz_order_details && transactions.orgz_order_details.length > 0 && (
                        <>
                          {/* <ul className='mb-8'> */}
               ...
               <h2 className="my-10">
                ...
                <div className="w-full lg:w-6/12 px-4">
                  <div className="relative w-full mb-3">
                    ...
                    {
                        transactions.orgz_order_participants && transactions.orgz_order_participants.length > 0 && (
                          <>
                            {/* <ul className='mb-8'> */}
                                {transactions.orgz_order_participants.map ((user, key) => (
